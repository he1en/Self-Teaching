...
var TodoList = React.createClass({
  ...
  deleteTodo: function(title) {
    var newData = this.state.data.filter(function (todo_elem) {
      return todo_elem.title != title
    })
    this.setState({data: newData})
  },
  render : function() {
    var deletefxn = this.deleteTodo
    var todo = this.state.data.map(function(obj) {
      return (
        <Todo title={obj.title} key={obj.title} onDelete={deletefxn}>
          {obj.detail}
        </Todo>
          )
    });
